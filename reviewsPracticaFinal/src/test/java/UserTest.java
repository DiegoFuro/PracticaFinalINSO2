...
public class UserTest {
    ...
    public void setUp() throws Exception {
        ...
        registerController2 = new registerController();
        registerController3 = new registerController();
    ...
    @Test
    public void testUserValido() {
        registerController2.setName("Juan"); 
        registerController2.setLastName("Rodriguez");
        registerController2.setUser("juanRod");
        registerController2.setPassword("password");
        registerController2.setIdRol(3);
        String resultado = registerController2.registerUser();
        assertTrue(resultado.equals("index.xhtml?faces-redirect=true"));
    }
    
    @Test
    public void testUserNoValido() {
        registerController3.setName("Juan"); 
        registerController3.setLastName("Rodriguez");
        registerController3.setUser("juanRod$");
        registerController3.setPassword("password");
        registerController3.setIdRol(3);
        String resultado = registerController3.registerUser();
        assertTrue(resultado.equals("index.xhtml?faces-redirect=true"));
    }
}